...
/**
 * Deze servlet zorgt voor de filters voor de paginas die alleen door de klant bezocht mogen worden
 */
public class SecurityFilterKlant implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
		...
		// Alleen klanten mogen bij klant pagina's/servlets komen
